...
const handleLogout = async() => {
  ...
  return (
    <section className="bg-white shadow-varient4 fixed top-0 left-0 right-0 z-20 md:px-4 xl:px-4 lg:py-2 py-2">
      <div className="md:pr-8 xl:pr-8 py-1">
        <div className="grid grid-cols-12 gap-2 items-center">
          ...
          <div
            className={` h-screen lg:hidden block responsive-menu fixed left-0 top-[55px] bg-white md:max-w-[320px] w-full z-[1] transition-all ease-in-out duration-500 delay-300 shadow-varient5 py-5  ${isHamburgerActive && isNavExpanded
                ? "-translate-x-[100%]"
                : "translate-x-[0]"
              }`}
          >
        ...
        {showModal &&
          ...
          //             formInstanceId='autonavid'
          //           />
          //       </div>
          //      </div>
          //    </div>
          //  </Modal>
          // <div className="mx-auto h-1.5 w-[50%] rounded-3xl bg-black-20 ">
