...
function PhotoRestoration({ componentType, Toolname }) {
  ...
  return (
    <div className="pt-12">
      <><Head>
        <title>Photo Restoration: Free Online AI Old Image Restoration</title>
        <meta name="title" content="Photo Restoration: Free Online AI Old Image Restoration" />
        <meta name="description" content="Restore Old Photos Online in Seconds with our powerful AI Image restoration. Fix scratches, restore details, and colorize with ease. Try it now!" />
        <meta name="robots" content="index, follow" />
        <link rel="icon" href="https://www.spyne.ai/wp-content/uploads/2023/01/cropped-favicon-1-180x180.png" sizes="any" />
        <link rel="canonical" href="https://www.spyne.ai/tools/photo-restoration" />
      </Head></>
