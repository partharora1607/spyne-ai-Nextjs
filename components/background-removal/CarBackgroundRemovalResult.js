...
import { downloadSingleImage } from '@/utils/downloadImage';
 ...
 function CarBackgroundRemovalResult({Toolname}) {
    const dispatch = useDispatch();
    const router = useRouter();

    const variable = useSelector((state) => state.variable);
    const [UserImage, setUserImage] = useState(variable);
    console.log('ye hai variable ki vallue:', variable);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          const response = await axios.post('https://toolsapi.spyne.ai/api/backgroundremover', data)
          .then((res) => {
                                        ...
                                        <div class="upscaler-factor-block block max-w-sm p-3 mb-8 bg-white border border-white rounded-xl shadow-[0_0px_16px_0px_rgba(64,35,135,0.08)] hover:border-500 hover:border-1 hover:border-[#CCCCCC]">
                                            <div className="grid grid-cols-12">
                                                ...
                                                <div className="lg:col-span-9">
                                                    <h5 class="mb-2 ">Automobile </h5>
                                                    <p class="font-medium ">Seden, SUV, Hatchback</p>
                                                </div>    
                                            </div>
                                        ...
                                        <div class="upscaler-factor-block block max-w-sm p-3 mb-8 bg-white border border-white rounded-xl shadow-[0_0px_16px_0px_rgba(64,35,135,0.08)] hover:border-500 hover:border-1 hover:border-[#CCCCCC]">
                                            <div className="grid grid-cols-12">
                                                ...
                                                <div className="lg:col-span-9">
                                                    ...
                                                    <p class="font-medium ">Packages , Bottles, Apparel, Housewares</p>
                                                </div>    
                                            </div>
                                    ...
                                    <label>
                                        ...
                                        <div class="upscaler-factor-block block max-w-sm p-3 mb-8 bg-white border border-white rounded-xl shadow-[0_0px_16px_0px_rgba(64,35,135,0.08)] hover:border-500 hover:border-1 hover:border-[#CCCCCC]">
                                            <div className="grid grid-cols-12">
                                                ...
                                                <div className="lg:col-span-9">
                                                    <h5 class="mb-2 ">Food</h5>
                                                    <p class="font-medium ">Baked goods , Cereals, Apparel, Meat</p>
                                                </div>    
                                            </div>
                                ...
                                <div className="ImagePrivewer mt-8 rounded-lg border-1 md:h-[70vh] lg:h-[70vh] xl:h-[70vh] h-[40vh] object-contain align-middle">
                                    ...
                                    <div className='previewimageclass'>
                                        ...
                                        <div className={afterImageClass}>
                                            {!imageLoaded && <div className="spinner z-10"></div>}
                                            <img className="affterimg w-full  md:h-[70vh] lg:h-[70vh] xl:h-[70vh] h-[40vh] object-contain align-middle" src={AfterImage} onLoad={handleImageLoad} onChange={handleImageLoad} style={{ display: imageLoaded ? 'block' : 'none' }}></img>
                                        </div>
                                    </div>
...
export default CarBackgroundRemovalResult;