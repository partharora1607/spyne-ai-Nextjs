        ...
        <section>
            ...
            <div className="grid grid-cols-12 h-[10vh]">
                ...
                <form onSubmit={handleSubmit} className="uploadFormrounded-lg border-dashed border border-black-300 bg-[#4A3AFF05]">
                    ...
                    <input className="h-[10vh] w-full opacity-0"  type="file" accept="image/*" onChange={handleFileChange} />
                    <div className="uploadBoxContent pb-3">
                        ...
                        <input className="opacity-0 h-0" type="file" id="imagefile" accept="image/*" onChange={handleFileChange}/> 
