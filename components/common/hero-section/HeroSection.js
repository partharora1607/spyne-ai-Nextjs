      ...
      <div className="container md:px-2">
        <div className="grid grid-cols-12 gap-x-5">
          <div className="md:col-span-6 col-span-12 order-2 sm:order-1">
            ...
            <input className="h-24 w-full opacity-0"  type="file" accept="image/*" onChange={handleFileChange}/>
              ...
              {/* <form onSubmit={handleSubmit} className="uploadForm">
                ...
                <button className="primary-btn flex gap-2 items-center mx-auto rounded-lg" onClick={toUploadPage}>
                <Image
